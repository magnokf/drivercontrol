        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/users/user/{$user->id}"); ?>" method="post">
                ...
                <div class="label_g2">
                    ...
                    <label class="label">
                        <span class="legend">Alterar Telefone:</span>
                        <input type="text" name="phone" class="mask-phone" value="<?= $user->phone; ?>" />
                    </label>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">Nascimento:</span>
                        <input type="text" class="mask-date" value="<?= ($user->datebirth ? date_fmt($user->datebirth, "d/m/Y") : null); ?>"
                ...
                <div class="label_g2">
                    ...
                    <label class="label">
                        ...
                        <input type="password" name="password" value="<?= ($user->password ? $user->password: null );?>" placeholder="Senha de acesso"/>
                    </label>

                </div>
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">*CNH:</span>
                        <input type="text" class="mask-cnh" name="cnhdoc" value="<?= $user->cnhdoc; ?>"
                               required/>
                    </label>

                    <label class="label">
                        <span class="legend">Validade CNH:</span>
                        <input type="text" name="cnhval" class="mask-date" value="<?= ($user->cnhval ? date_fmt($user->cnhval, "d/m/Y") : null); ?>"/>
                    </label>
                </div>
