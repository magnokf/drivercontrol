<?php $v->layout("_theme"); ?>
    ...
    <article class="home_featured">
        <div class="home_featured_content container content">
            <header class="home_featured_header">
                <h1>Seja Bem-Vindo Motorista de Apps!</h1>
                <h2>Tem contas a pagar e receber? Comece a controlar!</h2>
                <p>Cadastre-se, lance suas contas e conte com automações poderosas para gerenciar suas atividades e seus ganhos.
                </p>
        ...
        <div class="home_featured_app">
            <img src="<?= theme("/assets/images/home-app.jpg"); ?>" alt="DriverControl" title="DriverControl"/>
        </div>
    </article>
    ...
    <div class="home_features">
        <section class="container content">
            <header class="home_features_header">
                <h2>O que você pode fazer com o DriverControl?</h2>
            ...
            <div class="home_features_content">
                <article class="radius">
                    <header>
                        ...
                        <p>Cadastre seus recebíveis, use as automações para salários, contratos recorrentes e comece a
    ...
    <article class="home_optin">
        <div class="home_optin_content container content">
            <header class="home_optin_content_flex">
                <h2>Cadastre-se no DriverControl e comece a controlar suas contas hoje mesmo.</h2>
                <p>Receber e pagar são tarefas comuns e diárias. E o DriverControl vai te ajudar a gerenciar suas contas e atividades típicas do motorista de app. Tudo simples,
                    fácil e gratuito, <b>feito para ajudar você.</b></p>
                <p>Com ele você lança suas contas, cria recorrências e conta com as automações e relatórios poderosos que
                    controlam tudo enquanto você toma um bom café e fazer seu dia render muito mais.</p>
    ...
    <article class="home_video">
        <div class="home_video_content container content">
            <header>
                <h2>Descubra o DriverControl</h2>
