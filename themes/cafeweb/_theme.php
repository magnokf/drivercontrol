    ...
    <div class="container content">
        <section class="main_footer_content">
            <article class="main_footer_content_item">
                <h2>Sobre:</h2>
                <p>O DriverControl é um gerenciador de contas simples, poderoso e gratuito. O prazer de tomar um café e
            ...
            <article class="main_footer_content_item">
                ...
                <p class="icon-map-marker"><b>Endereço:</b><br><address>Rio de Janeiro, RJ/Brasil</address> </p>
            </article>
