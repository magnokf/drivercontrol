...
<section class="app_wallets">
    <article class="wallet wallet_add radius gradient-blue">
        ...
        <h3>Crie e gerencie suas carteiras | carros</h3>
        <p>Organize suas contas de diferentes fontes como <b>HB20S Placa</b>, <b>Minha Casa</b> para PF, <b>Minha Empresa</b> para PJ, ou
            ainda <b>Cartão 6431</b> para organizar cartões. Controle tudo...</p>
        <span class="btn wallet_action radius transition icon-plus-circle">Adicionar Carteira | Carro</span>

        <div class="wallet_overlay radius" style="background-color: var(--color-blue)">
            <div>
                <p>Insira o nome da sua nova carteira | carro, como <b>HB20S Placa</b>, <b>Minha Casa</b>, <b>Minha Empresa</b>, <b>Cartão 5546</b>...
                    e tudo pronto!</p>
