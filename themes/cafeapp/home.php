                    ...
                    <?php //if (!empty($posts)): ?>
                        <?php //foreach ($posts as $post): ?>
                            <article class="app_widget_blog_article">
                                <div class="thumb">
                                    <img alt="<?php //$post->title; ?>" title="<?php //$post->title; ?>"
                                         src="<?php //image($post->cover, 300); ?>"/>
                                </div>
                                <h3 class="title">
                                    <a target="_blank" href="<?php //url("/blog/{$post->uri}"); ?>"
                                       title="<?php //$post->title; ?>"><?php //str_limit_chars($post->title, 50); ?></a>
                                </h3>
                            </article>
                        <?php //endforeach; ?>
                    <?php //endif; ?>
                    <a target="_blank" href="<?php //url("/blog"); ?>" title="Blog"
                       <a class="app_widget_more transition">Ver Mais...</a>
                </div>-->
            </section>
        </section>
    </div>
