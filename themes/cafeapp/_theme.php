...
<div class="app">
    <header class="app_header">
        <h1><a href="<?= url("/app"); ?>" title="DriverApp">DriverControl  <span class="icon icon-car"></span> </a></h1>
    ...
    <footer class="app_footer">
        <span class="icon-coffee">
            DriverControl <span class="icon-car"></span> - Controle suas contas e suas atividades<br>
            &copy; DMRtech - Todos os direitos reservados
        </span>
    </footer>
