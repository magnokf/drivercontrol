...
<div class="app_formbox app_widget">
    <form class="app_form" action="<?= url("/app/profile"); ?>" method="post">
        ...
        <div class="label_group">
            <label>
                <span class="field icon-calendar">Validade CNH:</span>
                <input class="radius mask-date" type="text" name="cnhval" placeholder="dd/mm/yyyy" required
                       value="<?= ($user->cnhval ? date_fmt($user->cnhval, "d/m/Y") : null); ?>"/>
            </label>

            <label>
                <span class="field icon-briefcase">CNH Nº:</span>
                <input class="radius mask-cnh" type="text" name="cnhdoc" placeholder="Apenas números" required
                       value="<?= $user->cnhdoc; ?>"/>
            </label>
        </div>
        <div class="label_group">
            ...
            <label>
                ...
                <input class="radius mask-phone" type="text" name="phone" placeholder="Seu nº Celular" required
                       value="<?= $user->phone; ?>"/>
            </label>
        </div>
        <div class="label_group">
