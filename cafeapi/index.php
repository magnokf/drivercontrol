...
$route->post("/photocar", "Cars:photocar");
...
$route->group("/subscriptioncontract");
$route->get("/", "SubscriptionsContract:index");
$route->post("/", "SubscriptionsContract:create");
$route->get("/contract", "SubscriptionsContract:read");
$route->put("/", "SubscriptionsContract:update");
