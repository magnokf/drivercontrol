...
$route->get("/manutencao", "App:services_home");
$route->get("/oleo", "App:service");
$route->get("/carteiras", "App:wallets");
$route->get("/fatura/{invoice}", "App:invoice");
$route->get("/perfil", "App:profile");
$route->get("/cars", "App:cars");
...
//cars
$route->get("/cars/home", "Cars:home");
$route->post("/cars/home", "Cars:home");
$route->get("/cars/home/{search}/{page}", "Cars:home");
$route->get("/cars/car", "Cars:car");
$route->post("/cars/car", "Cars:car");
$route->get("/cars/car/{car_id}", "Cars:car");
$route->post("/cars/car/{car_id}", "Cars:car");
