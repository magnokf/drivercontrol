...
class AppCreditCard extends Model
{
    ...
    public function __construct()
    {
        ...
        $this->apiurl = "https://ws.sandbox.pagseguro.uol.com.br/v2/";
        if (CONF_PAGSEGURO_MODE == "live") {
            $this->apikey = CONF_PAGSEGURO_APPKEY_LIVE;
        } else {
            $this->apikey = CONF_PAGSEGURO_APPKEY_TESTE;
        }
    }
