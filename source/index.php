...
$user = [
    ...
    'user_email' => 'c39759432596376464392@sandbox.pagseguro.com.br',
...
$pay->getMemberShip('EB804B28636316D774356F88FC50801');
//var_dump($pay, $pay->getCallback());

// Chamada do método de resgate do objeto de transação
